...
\t";
        ...
        if (array_key_exists("modules", $context)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
                // line 15
                echo "\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("intra_module_voir_module", array("id" => $this->getAttribute((isset($context["module"]) ? $context["module"] : $this->getContext($context, "module")), "getId", array(), "method"))), "html", null, true);
