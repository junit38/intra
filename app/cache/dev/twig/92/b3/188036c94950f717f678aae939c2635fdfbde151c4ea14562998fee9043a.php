...
/* IntraForumBundle:Formulaire:thread.html.twig */
class __TwigTemplate_92b3188036c94950f717f678aae939c2635fdfbde151c4ea14562998fee9043a extends Twig_Template
{
...
\t<form role=\"form\" action=";
        // line 9
        echo $this->env->getExtension('routing')->getPath("intra_forum_ajouter_thread");
        echo " method=\"POST\" 
\tonsubmit=\"return (this._sujet.value.length > 0 && this._content.value.length > 0)\">
\t  <div class=\"form-group\">
\t    <label for=\"sujet\">Sujet</label>
\t    <input type=\"text\" class=\"form-control\" id=\"sujet\" name=\"_sujet\" placeholder=\"Entrez votre sujet\">
\t  </div>
\t  <div class=\"form-group\">
\t  \t<label for=\"_content\">Contenu</label>
\t  \t<textarea class=\"form-control\" rows=\"6\" id=\"_content\" name=\"_content\"></textarea>
\t  </div>
\t  <input type=\"hidden\" name=\"_id_categorie\" value=\"";
        // line 19
...
";
    ...
    {
        return "IntraForumBundle:Formulaire:thread.html.twig";
    }
