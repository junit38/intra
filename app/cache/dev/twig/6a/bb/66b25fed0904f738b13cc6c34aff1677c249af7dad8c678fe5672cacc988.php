...
/* IntraModuleBundle:Module:inscrit_module.html.twig */
class __TwigTemplate_6abb66b25fed0904f738b13cc6c34aff1677c249af7dad8c678fe5672cacc988 extends Twig_Template
{
...
\t";
        ...
        if (array_key_exists("module", $context)) {
            // line 10
            echo "\t\t<h4>Il y a ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["module"]) ? $context["module"] : $this->getContext($context, "module")), "getInscrit", array(), "method"), "count", array(), "method"), "html", null, true);
            echo " inscrit au module ";
...
\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["module"]) ? $context["module"] : $this->getContext($context, "module")), "getInscrit", array(), "method"));
            foreach ($context['_seq'] as $context["_key"] => $context["inscrit"]) {
                // line 15
                echo "\t\t\t\t<li>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["inscrit"]) ? $context["inscrit"] : $this->getContext($context, "inscrit")), "getUsername", array(), "method"), "html", null, true);
                echo "
\t\t\t\t</li>
\t\t";
            }
...
\t\t";
            // line 21
            if (twig_test_empty($this->getAttribute((isset($context["module"]) ? $context["module"] : $this->getContext($context, "module")), "getInscrit", array(), "method"))) {
                // line 22
                echo "\t\t\t<p>Encore aucun inscrit à ce module</p>
\t\t";
            }
            // line 24
            echo "
...
";
    ...
    {
        return "IntraModuleBundle:Module:inscrit_module.html.twig";
    }
