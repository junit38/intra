...
/* IntraModuleBundle:Activite:inscrit.html.twig */
class __TwigTemplate_89247e2b78b847401180ca6973123cf02c39c8b9aadfee7fb554a28c56724f41 extends Twig_Template
{
...
\t";
        ...
        if (array_key_exists("activite", $context)) {
            // line 10
            echo "\t\t<h4>Il y a ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["activite"]) ? $context["activite"] : $this->getContext($context, "activite")), "getInscrit", array(), "method"), "count", array(), "method"), "html", null, true);
            echo " inscrit à l'activite ";
...
\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["activite"]) ? $context["activite"] : $this->getContext($context, "activite")), "getInscrit", array(), "method"));
...
\t\t";
            // line 21
            if (twig_test_empty($this->getAttribute((isset($context["activite"]) ? $context["activite"] : $this->getContext($context, "activite")), "getInscrit", array(), "method"))) {
                // line 22
                echo "\t\t\t<p>Encore aucun inscrit à ce activite</p>
\t\t";
            }
            // line 24
            echo "
...
";
    ...
    {
        return "IntraModuleBundle:Activite:inscrit.html.twig";
    }
