 ...
 */
class Reply extends \Intra\TicketBundle\Entity\Reply implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Intra\\TicketBundle\\Entity\\Reply' . "\0" . 'id', '' . "\0" . 'Intra\\TicketBundle\\Entity\\Reply' . "\0" . 'contenu', '' . "\0" . 'Intra\\TicketBundle\\Entity\\Reply' . "\0" . 'datetime', '' . "\0" . 'Intra\\TicketBundle\\Entity\\Reply' . "\0" . 'auteur', '' . "\0" . 'Intra\\TicketBundle\\Entity\\Reply' . "\0" . 'auteur_id', '' . "\0" . 'Intra\\TicketBundle\\Entity\\Reply' . "\0" . 'ticket_id');
        }
